...
def test_fit_primary_beams(ants, target, x_param):
    ...
    #
    # assert (beam_centre[:, 0] == numpy.array(
    #     [4.6571771692076765e+37, -6.096692901691223e+65, -6.096692901691223e+65])).all()

    print(fitted_results[:, 0])
    print(type(fitted_results[:, 0]))
    print("")

    print(numpy.array([-1.64887700e+34, 3.04474870e+65, 3.84845002e+92]))
    print(numpy.array([-1.64887700e34, 3.04474870e65, 3.84845002e92]).all())
    print(type(numpy.array([-1.64887700e+34, 3.04474870e+65, 3.84845002e+92])))
    ...
    # print(numpy.array(
    #         [
    #             # [3.254171935136081e22, -29.038115303488933],
    #             # [-3.647690426807241e75, -1333.881344893416],
    #             # [-4.103378475452472e125, -0.3486315369947863],
    #
    #             [-1.64887700e+34 - 2.90979274e+01],
    #              [3.04474870e+65 - 5.28146099e+02],
    #              [3.84845002e+92 - 3.48631541e-01],
    #         ]
    #     ))

    # assert fitted_results
    numpy.testing.assert_array_almost_equal(fitted_results[:, 0][0], numpy.array([round(-1.6488769988931003e+34, 6)]))

    assert (
        fitted_results[:, 0][0]
        == numpy.array([-1.6488769988931003e+34])).all()
    # assert (
    #     beam_width
    #     == numpy.array(
    #         [
    #             [8.003076693136527e47, 10.372256193900368],
    #             [9.728521912011856e100, 2280.7450298841686],
    #             [1.9193812352391287e151, 1.2158218660072313],
    #         ]
    #     )
    # ).all()
    # assert (
    ...
    #     == numpy.array(
    #         [
    #             [22589261818023.336, 22589261818023.336],
    #             [39716.33596414203, 39716.33596414203],
    #             [22078.664780737774, 22078.664780737774],
    #         ]
    #     )
    # ).all()
    # assert (
