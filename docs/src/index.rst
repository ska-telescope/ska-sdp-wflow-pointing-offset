.. SDP Pointing Offset Calibration Pipeline documentation master file, created by
   sphinx-quickstart on Sat Feb  4 13:54:30 2023.
...
the cross-correlation visibility amplitudes of each baseline. Note that the final pipeline would instead fit primary beams to the complex
